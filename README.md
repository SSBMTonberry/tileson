...
## Windows
For compiling the demo on Windows, it's recommended to use either Visual Studio or Visual Studio Code and open the CMakeLists.txt on the root level of the project. Also: The examples on windows will probably require the program to be built in `x86`. Some screenshots to showcase how CMake should be configured to build the demo using Visual Studio 2019:
...
Simply call it like this: `sh amalgamate_script.sh`. These is also a .bat-version of this script for Windows.
